...
int main()
{
    ...
    outln("const OBJECT_FLAG_HAS_MAGICAL_LENGTH = {}", static_cast<u16>(Object::Flag::HasMagicalLengthProperty));
    outln("const OBJECT_FLAG_MAY_INTERFERE = {}", static_cast<u16>(Object::Flag::MayInterfereWithIndexedPropertyAccess));
    outln("const OBJECT_FLAG_IS_TYPED_ARRAY = {}", static_cast<u16>(Object::Flag::IsTypedArray));
    outln("const OBJECT_FLAG_IS_FUNCTION = {}", static_cast<u16>(Object::Flag::IsFunction));
    outln("const OBJECT_FLAG_IS_ECMASCRIPT_FUNCTION_OBJECT = {}", static_cast<u16>(Object::Flag::IsECMAScriptFunctionObject));
    outln("const OBJECT_FLAG_IS_RAW_NATIVE_FUNCTION = {}", static_cast<u16>(Object::Flag::IsRawNativeFunction));
