...
public:
    ...
    //    Content Security Policy?. It returns "Allowed" unless otherwise specified.
    virtual Result navigation_response_check(GC::Ptr<Fetch::Infrastructure::Request const>, NavigationType, GC::Ref<Fetch::Infrastructure::Response const>, GC::Ref<HTML::Navigable const>, CheckType, GC::Ref<Policy const>) const { return Result::Allowed; }
